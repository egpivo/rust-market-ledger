...
//!
//! This module contains both the core PBFT logic (PBFTManager, PBFTMessage, etc.)
//! and the ConsensusAlgorithm trait adapter (PBFTConsensus).
...
// Core PBFT types and structures
...
// ConsensusAlgorithm trait adapter
